...
javascript: (function () {
    ...
    var bd = doc.body;
    // bd = document.body
    bd.onselectstart = bd.oncopy = bd.onpaste = bd.onkeydown = bd.oncontextmenu =
        bd.onmousemove = bd.ondragstart =
        doc.onselectstart = doc.oncopy = doc.onpaste = doc.onkeydown = doc.oncontextmenu = null;
